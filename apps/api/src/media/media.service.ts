...
export class MediaService {
  ...
  async createUploadUrl(params: {
    ...
    const configuredMaxBytes = Number(maxBytesRaw ?? DEFAULT_MAX_UPLOAD_BYTES);
    ...
    // Keep runtime behavior aligned with the contract: the API will not accept
    // uploads larger than 5MB without a code + contract change.
