...
describe('UsersController', () => {
  ...
  describe('getUserProfile', () => {
    it('should return user profile when user exists', async () => {
      ...
      const req = {} as unknown as Request & { user?: AuthUser | null };

      const result = await controller.getUserProfile(req, 'testuser');
    ...
    it('should handle various username formats', async () => {
      ...
      for (const username of usernames) {
        ...
        const result = await controller.getUserProfile(req, username);
